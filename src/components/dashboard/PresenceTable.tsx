              ...
              >
                ...
                <td className="p-4">
                  ...
                  >
                    <span className={cn(
                      ...
                      employee.status === 'IN' ? 'bg-success' : 'bg-muted-foreground'
                    )} />
                ...
                <td className="p-4">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">{employee.zone}</p>
                  </div>
                </td>
                <td className="p-4 text-sm text-muted-foreground">
                  {formatDistanceToNow(employee.lastDetected, { addSuffix: true })}
                </td>
              </tr>
            ))}
          </tbody>
